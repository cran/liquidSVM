...
use the standard install procedure using our repository:
...
```
R CMD INSTALL path-to-package/liquidSVM_1.0.0.tar.gz
# Windows
Rcmd INSTALL path-to-package/liquidSVM_1.0.0.zip
# MacOS X using Termninal
R CMD INSTALL path-to-package/liquidSVM_1.0.0.tgz
```
or in a running R session:
```r
install.packages("path-to-package/liquidSVM_1.0.0.tar.gz",repos=NULL)
# Windows binary
install.packages("path-to-package/liquidSVM_1.0.0.zip",repos=NULL)
# MacOS X binary
install.packages("path-to-package/liquidSVM_1.0.0.tgz",repos=NULL)
```
...
```
R CMD INSTALL --configure-args=native path-to-package/liquidSVM_1.0.0.tar.gz
R CMD INSTALL --configure-args=generic path-to-package/liquidSVM_1.0.0.tar.gz
R CMD INSTALL --configure-args="empty -march=core2 -O3" path-to-package/liquidSVM_1.0.0.tar.gz
```
or in a running R session:
```r
install.packages("liquidSVM",configure.args="native",repos="http://www.isa.uni-stuttgart.de/software/R")
install.packages("liquidSVM",configure.args="generic",repos="http://www.isa.uni-stuttgart.de/software/R")
install.packages("liquidSVM",configure.args="empty -march=core2 -O3",repos="http://www.isa.uni-stuttgart.de/software/R")
```
...
```
R CMD INSTALL --configure-args="native /my/path/to/cuda" path-to-package/liquidSVM_1.0.0.tar.gz
```
or again in R
```r
